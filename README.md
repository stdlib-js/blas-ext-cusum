...
```javascript
import cusum from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-cusum@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-cusum@v0.1.1-deno/mod.js';
```
